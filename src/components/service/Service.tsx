        ...
        <div className="serv-text-box">
          <div className="bg-holder">
            ...
            <div className="service-text__container">
              ...
              <h3>
                Bardzo dobrze odnajduje się w negocjacjach handlowych, pracy pod
                presją czasu, oraz środowisku sprzedaży produktów luksusowych.
              </h3>
              <p>
              ...
              <p>
                ...
                profesjonale sesje zdjęciowe, perswazyjne opisy tekstowe i wiele
                więcej, czyli wszystko, co sprawia, że prezentowane oferty
                wyróżniają się na tle konkurencji i umożliwiają dotarcie do
                znacznie szerszej grupy osób potencjalnie zainteresowanych
                zakupem.
              </p>
            </div>
          </div>
        ...
        <div className="bg-box">
          ...
          <div className="serv-windows">
            <div className="wind-box">
              ...
              <h3>Sprzedaż</h3>
              <Link to="/service/sell"> <button>Zobacz więcej</button></Link>
            </div>

            <div className="wind-box">
              <img src={ser2} alt="box" />
              <h3>Wynajem</h3>
              <Link to="/service/rent">  <button>Zobacz więcej</button></Link>
            </div>
