      ...
      <article className="rodo">
        ...
        <ul>
          ...
          <li>
            ...
            &quot;nataliamalycha.com &quot;, działających pod adresem
            https://nataliamalycha.com{" "}
          </li>
          <li>
            <strong>Usługodawca</strong> – firma &quot;Natalia Małycha &quot; z
            adresem siedziby: ul. Strzelców 18/8, Gdynia 81-586, NIP:
            5951402232,{" "}
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            ...
            wskazówek lub porad publikowane na łamach Serwisu są jedynie ogólnym
            zbiorem informacji i nie są kierowane do poszczególnych
          ...
          <li>
            ...
            z korzystaniem z Serwisu. Wszelkie ryzyko związane z korzystaniem z
        ...
        <ul>
          ...
          <li>
            ...
            korzystający z Serwisu powinni stosować się do ogólnie przyjętych{" "}
        ...
        <h2>IV. Warunki świadczenia usługi Newsletter</h2>
        <ul>
          <li>
            Usługobiorcy mogą korzystać z Serwisu bez konieczności zapisywania
            się do Newslettera.
          </li>
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://nataliamalycha.com/polityka-prywatnosci/">
        ...
        <p>
          ...
          Serwisu gromadzi i przetwarza niektóre dane o Użytkownikach.
        </p>
        <p>
        ...
        <p>
          ...
          <a href="https://nataliamalycha.com/rodo">
        ...
        <ul>
          ...
          <li>
            ...
            innych treści, materiałów graficznych, wideo lub audio znajdujących
            się w Serwisie bez pisemnej zgody lub zgody przekazanej za pomocą
          ...
          <li>
            ...
            tekstów, ale już nie kopiowania całości lub części artykułów o ile
            nie zostało to oznaczone w poszczególnym materiale udostępnionym w
            Serwisie.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            ...
            konieczności uprzedniego powiadomienia Usługobiorców korzystających
            z usług Serwisu.
          </li>
          <li>
          ...
          <li>
            ...
            bez zgody i możliwości wyrażania jakichkolwiek sprzeciwów przez
            Usługobiorców.
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Wysyłając wiadomość na adres e-mail: office@nataliamalycha.com
              </li>
              <li>
                Poprzez połączenie telefoniczne z numerem: +48 787 665 881
              </li>
            </ul>
