  ...
  return (
    ...
    <div className="rodo">
        ...
        <p>
          ...
          <a href="nataliamalycha.com/polityka-prywatnosci">
        ...
        <p>
          ...
          "Natalia Małycha ", prowadząca działalność pod adresem: ul. Strzelców
          18/8, Gdynia 81-586 , o nadanym numerze identyfikacji podatkowej
          (NIP): 5951402232, świadcząca usługi drogą elektroniczną za
