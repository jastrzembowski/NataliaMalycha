  ...
  return (
    ...
    <div className="rodo">
      ...
      <p>
        ...
        <a href="nataliamalycha.com/polityka-prywatnosci">Regulaminu Serwisu</a>
      ...
      <ul>
        <li>
          <p>
            <strong>Serwis</strong> - serwis internetowy "nataliamalycha.com "
            działający pod adresem https://nataliamalycha.com
          </p>
        </li>{" "}
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            "Natalia Małycha ", prowadząca działalność pod adresem: ul.
            Strzelców 18/8, Gdynia 81-586 , o nadanym numerze identyfikacji
            podatkowej (NIP): 5951402232, świadcząca usługi drogą elektroniczną
        ...
        <li>
          <p>
            ...
            <a rel="external" href="https://nety.pl/cyberbezpieczenstwo/">
              zasad bezpiecznego korzystania z sieci
            </a>
            .
          </p>
        </li>
      ...
      <ul id="cele">
        ...
        <li>Usługi serwowania reklam</li> <li>Usługi afiliacyjne</li>
        <li>
      ...
      <ul id="zewnetrzne">
        <li>
          ...
          <ul>
            <li>
              <a rel="nofollow external" href="https://www.youtube.com/t/terms">
                YouTube
              </a>
            </li>
          </ul>
      ...
      <p>
        Administrator w celu świadczenia usługi Newsletter, korzysta z usług
        podmiotu trzeciego - serwisu{" "}
        <strong>
          <a
            rel="nofollow external"
            href="https://mailchimp.com/legal/privacy/"
        ...
        . Dane wprowadzone w formularzu zapisu do newslettera są przekazywane,
        przechowywane i przetwarzane w serwisie zewnętrznym tego usługodawcy.
      </p>
      <p>
        Informujemy, że wskazany partner może modyfikować wskazaną politykę
        prywatności bez zgody Administratora.
      </p>
      <br />
      <p>
        <strong>
      ...
      <ul>
        <li>
          <p>
            <strong>Adres pocztowy</strong> - Natalia Małycha , ul. Strzelców
            18/8, Gdynia 81-586{" "}
          </p>
        </li>{" "}
        <li>
          <p>
            ...
            office@nataliamalycha.com
          </p>
        </li>{" "}
        <li>
          <p>
            <strong>Połączenie telefoniczne</strong> - +48 787 665 881
          </p>
        </li>{" "}
        <li>
          <p>
