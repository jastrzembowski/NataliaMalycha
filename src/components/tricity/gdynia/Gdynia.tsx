    ...
    <header className="gdy-bg">
      ...
      <article className="gda-about">
        <article className="gdy-about__head">
          <h1>Gdynia</h1>
          <p>
            Gdynia nazywana miastem powstałym z morza i marzeń. Jeszcze 100 lat
            temu znajdowała się tu niewielka wieś rybacka, a dziś to znany
            kurort i największe niewojewódzkie miasto. Ten nowoczesny ośrodek
            konkuruje o względy turystów z Sopotem i Gdańskiem, z którymi tworzy
            Trójmiasto.
          </p>
        </article>
        ...
        <article className="gda-box">
          ...
          <aside>
            ...
            <p>
              ...
              Kościuszki. Większość turystów nie wyobraża sobie wizyty w mieście
              bez przechadzki nadmorskim deptakiem pełnym restauracji, kafejek i
              straganów. Na Skwerze oraz jego przedłużeniu – Molu Południowym –
              można miło spędzić czas, po prostu spacerując lub siedząc, sporo
              tu jednak atrakcji, które dodatkowo mogą uatrakcyjnić pobyt.
            </p>
          </aside>
        </article>
        <article className="gda-box">
          <aside>
            ...
            <h3>
              ...
              1929 roku należy do Polski. Od tego momentu przepłynął pół miliona
              mil morskich, co można porównać do 25 rejsów dookoła Ziemi. W tym
              też czasie wyszkolił ponad 13 tys. studentów.
            </h3>
            <p>
              W 1983 roku otwarto w nim muzeum, które jest jednym z symboli
              Gdyni. Przechadzając się po pokładzie oraz poszczególnych kajutach
              i maszynowni, poznaje się fascynującą historię żaglowca oraz
        ...
        <article className="gda-box">
          ...
          <aside>
            ...
            <h3>
              ...
              najstarszym na świecie unoszącym się na wodzie niszczycielem oraz
              jedynym bojowym okrętem alianckim, który aktywnie uczestniczył w
              działaniach przez cały okres II wojny światowej.
            </h3>
            <p>
        ...
        <article className="gda-box">
          <aside>
            ...
            <h3>
              W muzeum poznaje się historię oręża polskiego na morzu oraz bogaty
              zbiór broni z czasów II wojny światowej i okresu powojennego.
            </h3>
            <p>
        ...
        <article className="gda-box">
          <aside>
            ...
            <h3>
              ...
              szczególnie można polecić? Wiele osób uważa, że najlepsza gdyńska
              plaża znajduje się niedaleko Skweru Kościuszki, tuż za mariną. Nie
              należy ona może do największych, ale to nadaje jej kameralny urok.
            </h3>
            <p>
        ...
        <article className="gda-box">
          ...
          <aside>
            ...
            <p>
              ...
              nowoczesną multimedialną oprawę. Muzeum, jako pierwsze na terenie
              Polski, gromadzi i prezentuje zbiory dotyczące polskiej emigracji,
              a także osiągnięć naszych rodaków za granicą.{" "}
            </p>
          </aside>
        </article>
        <article className="gda-box">
          <aside>
            ...
            <p>
              Osoby szukające spokoju powinny udać się do graniczącej z Sopotem
              gdyńskiej dzielnicy Orłowo. Jedną z jej atrakcji jest piękne
              drewniane molo, którego historia sięga I wojny światowej. W ramach
              konkurowania z Sopotem drewniany pomost zaczęto rozbudowywać, by w
              latach 30. XX wieku molo osiągnęło długość 430 m. Niestety,
              większość mola uległa zniszczeniu podczas sztormu w 1949 roku. Po
        ...
        <article className="gda-box">
          ...
          <aside>
            ...
            <p>
              ...
              zobaczyć, jest Klif Orłowski. Stanowi on stromy brzeg morski Kępy
              Redłowskiej i rozciąga na długość 650 m. Szczególnie spacer od
              strony mola w Orłowie na długo pozostanie w pamięci. Klif
